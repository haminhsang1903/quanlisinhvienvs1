...
@Component({
  selector: 'app-student-new-vl',
  templateUrl: './student-new-vl.component.html',
  styleUrls: ['./student-new-vl.component.css']
})
export class StudentNewVLComponent implements OnInit {
