...
@Component({
  selector: 'app-student-new-ht',
  templateUrl: './student-new-ht.component.html',
  styleUrls: ['./student-new-ht.component.css']
})
export class StudentNewHTComponent implements OnInit {
